<?php
   ...
   if (strpos($message, "/tiempo") === 0) {
      ...
      $weather = json_decode(file_get_contents("https://api.openweathermap.org/data/2.5/weather?q=London,Uk&callback=test&appid=a32b06b98aa8fdc06e5902d229eb2055"), TRUE)["weather"][0]["main"];
